...
/** Shopping cart
 *
 * connects to store to get info about cart and dispatches actions to store on adding to cart.
 *
...
function Cart() {
  ...
  const { cartItems, cartValue, discountAmount, discountApplied, products } =
  ...
  return cartItems.length === 0 ? (
    ...
    <div>
      ...
      <form onSubmit={handleDiscount} className="form-inline">
        <label htmlFor="discount">Discounts Available:</label>
        <p>
          REMOVE10 <br />
          REMOVE20 <br />
          REMOVE30
